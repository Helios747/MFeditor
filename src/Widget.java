...
//              written by Jeremy Anders
				...
				new ParameterChoice("bin_coverage", "are values distributed over most of the globe or only a relatively small portion?", G, true, true, new String[]{"GLOBAL", "PARTIAL"}, 0),
				
				new ParameterChoice("cell_output_control", "designates which cells to output", G, true, true, new String[]{"OUTPUT_ALL", "OUTPUT_OCCUPIED"}, 0),
				
				new ParameterChoice("input_address_type", "cell address form in input file(s)", G, true, true, new String[]{"GEO", "Q2DI", "SEQNUM", "Q2DD", "PROJTRI", "VERTEX2DD"}, 0),
				
				new ParameterString("input_delimiter", "character that delimits address components and additional data in the input files", G, " "),
				
				new ParameterString("input_files", "name(s) of files containing lon/lat locations with associated values", G, "" ),
				
				new ParameterString("kml_description", "description tag value in KML output file", G, "/*PLACE HOLDER FOR Generated by DGGRID v6.2*/"),
				
				new ParameterString("kml_name", "name tag value in KML output file", G, "/*PLACE HOLDER FOR the output file name*/"),
				
				new ParameterChoice("output_address_type", "address form to use in output", G, true, true, new String[]{"GEO", "Q2DI", "SEQNUM", "INTERLEAVE", "PLANE", "Q2DD", "PROJTRI", "VERTEX2DD", "AIGEN"}, 2),
				
				new ParameterBoolean("output_count", "output the count of classes which are present between the cell address and the presence vector?", G, true),
				
				new ParameterString("output_delimiter", "character that delimits address components and additional data in the output file", G, " "),
				
				new ParameterString("output_file_name", "name of file to use for output", G, "valsout.txt"),
